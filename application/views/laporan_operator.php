                    ...
                    ?>
                      ...
                      <td>
                        <?php if (pathinfo($row['foto'], PATHINFO_EXTENSION) == "mp4") {
                          echo "<a><button class=\"btn btn-default open_modal\" data-toggle=\"modal\" data-target=\"#myModal\" data-video=\"".site_url('/uploads/PelaporanOperator')."/".$row['foto']."\"><span class=\"fa fa-play\"></span> Play</button></a>";
                        }
                        else{
                          echo "<img src=\"".site_url('/uploads/PelaporanOperator')."/".$row['foto']."\" style=\"width:80px; height:80px;\">";
                        } ?>
                      </td>
